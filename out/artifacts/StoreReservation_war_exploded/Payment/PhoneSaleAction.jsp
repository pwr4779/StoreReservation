...
<%
    ...
    int result_1 = PayDAO.AffiliatePaymentInsert(OrderNo, 20, SaleCoupon, Amount, InstallMonth,UsingPoint); // 결제 테이블 (쿠폰 할인, 포인트사용)
    ...
    int result_3 = PayDAO.PhoneDiscountTableInsert(OrderNo, PhoneCom, Phone); // 통신사할인테이블 내역 삽입
